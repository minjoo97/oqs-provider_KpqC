...
#define OQS_OID_CNT 280
#else
#define OQS_OID_CNT 172
#endif
...
"1.3.9999.14.1.1", "haetae2",
"1.3.9999.14.1.2" , "p256_haetae2",
"1.3.9999.14.2.1", "haetae3",
"1.3.9999.14.2.2" , "p384_haetae3",
"1.3.9999.14.3.1", "haetae5",
"1.3.9999.14.3.2" , "p521_haetae5",
"1.3.9999.11.1.1", "aimer128s",
"1.3.9999.11.1.2" , "p256_aimer128s",
"1.3.9999.11.1.3", "aimer128f",
"1.3.9999.11.1.4" , "p256_aimer128f",
"1.3.9999.11.2.1", "aimer192s",
"1.3.9999.11.2.2" , "p384_aimer192s",
"1.3.9999.11.2.3", "aimer192f",
"1.3.9999.11.2.4" , "p384_aimer192f",
"1.3.9999.11.3.1", "aimer256s",
"1.3.9999.11.3.2" , "p521_aimer256s",
"1.3.9999.11.3.3", "aimer256f",
"1.3.9999.11.3.4" , "p521_aimer256f",
...
if ((envval = getenv("OQS_OID_NTRU_PLUS_KEM576"))) oqs_oid_alg_list[70] = envval;

if ((envval = getenv("OQS_OID_P256_NTRU_PLUS_KEM576"))) oqs_oid_alg_list[72] = envval;
if ((envval = getenv("OQS_OID_X25519_NTRU_PLUS_KEM576"))) oqs_oid_alg_list[74] = envval;
if ((envval = getenv("OQS_OID_NTRU_PLUS_KEM768"))) oqs_oid_alg_list[76] = envval;

if ((envval = getenv("OQS_OID_P384_NTRU_PLUS_KEM768"))) oqs_oid_alg_list[78] = envval;
if ((envval = getenv("OQS_OID_X448_NTRU_PLUS_KEM768"))) oqs_oid_alg_list[80] = envval;
if ((envval = getenv("OQS_OID_NTRU_PLUS_KEM864"))) oqs_oid_alg_list[82] = envval;

if ((envval = getenv("OQS_OID_P384_NTRU_PLUS_KEM864"))) oqs_oid_alg_list[84] = envval;
if ((envval = getenv("OQS_OID_X448_NTRU_PLUS_KEM864"))) oqs_oid_alg_list[86] = envval;
...
#define OQS_KEMOID_CNT 0
   ...
   if ((envval = getenv("OQS_OID_HAETAE2"))) oqs_oid_alg_list[136+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_P256_HAETAE2"))) oqs_oid_alg_list[138+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_HAETAE3"))) oqs_oid_alg_list[140+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_P384_HAETAE3"))) oqs_oid_alg_list[142+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_HAETAE5"))) oqs_oid_alg_list[144+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_P521_HAETAE5"))) oqs_oid_alg_list[146+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_AIMER128S"))) oqs_oid_alg_list[148+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_P256_AIMER128S"))) oqs_oid_alg_list[150+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_AIMER128F"))) oqs_oid_alg_list[152+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_P256_AIMER128F"))) oqs_oid_alg_list[154+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_AIMER192S"))) oqs_oid_alg_list[156+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_P384_AIMER192S"))) oqs_oid_alg_list[158+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_AIMER192F"))) oqs_oid_alg_list[160+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_P384_AIMER192F"))) oqs_oid_alg_list[162+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_AIMER256S"))) oqs_oid_alg_list[164+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_P521_AIMER256S"))) oqs_oid_alg_list[166+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_AIMER256F"))) oqs_oid_alg_list[168+OQS_KEMOID_CNT] = envval;
   if ((envval = getenv("OQS_OID_P521_AIMER256F"))) oqs_oid_alg_list[170+OQS_KEMOID_CNT] = envval;
...
// clang-format off
    ...
    SIGALG("p256_haetae2", 128, oqs_p256_haetae2_keymgmt_functions),
#endif
#ifdef OQS_ENABLE_SIG_haetae_3
    SIGALG("haetae3", 192, oqs_haetae3_keymgmt_functions),
    SIGALG("p384_haetae3", 192, oqs_p384_haetae3_keymgmt_functions),
#endif
#ifdef OQS_ENABLE_SIG_haetae_5
    SIGALG("haetae5", 256, oqs_haetae5_keymgmt_functions),
    SIGALG("p521_haetae5", 256, oqs_p521_haetae5_keymgmt_functions),
#endif
#ifdef OQS_ENABLE_SIG_aimer_128s
    SIGALG("aimer128s", 128, oqs_aimer128s_keymgmt_functions),
    SIGALG("p256_aimer128s", 128, oqs_p256_aimer128s_keymgmt_functions),
#endif
#ifdef OQS_ENABLE_SIG_aimer_128f
    SIGALG("aimer128f", 128, oqs_aimer128f_keymgmt_functions),
    SIGALG("p256_aimer128f", 128, oqs_p256_aimer128f_keymgmt_functions),
#endif
#ifdef OQS_ENABLE_SIG_aimer_192s
    SIGALG("aimer192s", 192, oqs_aimer192s_keymgmt_functions),
    SIGALG("p384_aimer192s", 192, oqs_p384_aimer192s_keymgmt_functions),
#endif
#ifdef OQS_ENABLE_SIG_aimer_192f
    SIGALG("aimer192f", 192, oqs_aimer192f_keymgmt_functions),
    SIGALG("p384_aimer192f", 192, oqs_p384_aimer192f_keymgmt_functions),
#endif
#ifdef OQS_ENABLE_SIG_aimer_256s
    SIGALG("aimer256s", 256, oqs_aimer256s_keymgmt_functions),
    SIGALG("p521_aimer256s", 256, oqs_p521_aimer256s_keymgmt_functions),
#endif
#ifdef OQS_ENABLE_SIG_aimer_256f
    SIGALG("aimer256f", 256, oqs_aimer256f_keymgmt_functions),
    SIGALG("p521_aimer256f", 256, oqs_p521_aimer256f_keymgmt_functions),
#endif
