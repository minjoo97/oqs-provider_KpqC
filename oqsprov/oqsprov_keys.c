...
static oqs_nid_name_t nid_names[NID_TABLE_LEN] = {
  ...
  { 0, "ntru_plus_kem576", OQS_KEM_alg_ntrupkem_576, KEY_TYPE_KEM, 128, 0 },
  { 0, "p256_ntru_plus_kem576", OQS_KEM_alg_ntrupkem_576, KEY_TYPE_ECP_HYB_KEM , 128, 0 },
  { 0, "x25519_ntru_plus_kem576", OQS_KEM_alg_ntrupkem_576,  KEY_TYPE_ECX_HYB_KEM , 128, 0 },
  { 0, "ntru_plus_kem768", OQS_KEM_alg_ntrupkem_768, KEY_TYPE_KEM, 192, 0 },
  { 0, "p384_ntru_plus_kem768", OQS_KEM_alg_ntrupkem_768, KEY_TYPE_ECP_HYB_KEM , 192, 0 },
  { 0, "x448_ntru_plus_kem768", OQS_KEM_alg_ntrupkem_768,  KEY_TYPE_ECX_HYB_KEM , 192, 0 },
  { 0, "ntru_plus_kem864", OQS_KEM_alg_ntrupkem_864, KEY_TYPE_KEM, 192, 0 },
  { 0, "p384_ntru_plus_kem864", OQS_KEM_alg_ntrupkem_864, KEY_TYPE_ECP_HYB_KEM , 192, 0 },
  { 0, "x448_ntru_plus_kem864", OQS_KEM_alg_ntrupkem_864,  KEY_TYPE_ECX_HYB_KEM , 192, 0 },
  { 0, "ntru_plus_kem1152", OQS_KEM_alg_ntrupkem_1152, KEY_TYPE_KEM, 256, 0 },
  { 0, "p521_ntru_plus_kem1152", OQS_KEM_alg_ntrupkem_1152, KEY_TYPE_ECP_HYB_KEM , 256, 0 },
  { 0, "smaug-t1", OQS_KEM_alg_smaug_t1, KEY_TYPE_KEM, 128, 0 },
  { 0, "p256_smaug-t1", OQS_KEM_alg_smaug_t1, KEY_TYPE_ECP_HYB_KEM , 128, 0 },
  { 0, "x25519_smaug-t1", OQS_KEM_alg_smaug_t1,  KEY_TYPE_ECX_HYB_KEM , 128, 0 },
  { 0, "smaug-t3", OQS_KEM_alg_smaug_t3, KEY_TYPE_KEM, 192, 0 },
  { 0, "p384_smaug-t3", OQS_KEM_alg_smaug_t3, KEY_TYPE_ECP_HYB_KEM , 192, 0 },
  { 0, "x448_smaug-t3", OQS_KEM_alg_smaug_t3,  KEY_TYPE_ECX_HYB_KEM , 192, 0 },
  { 0, "smaug-t5", OQS_KEM_alg_smaug_t5, KEY_TYPE_KEM, 256, 0 },
  { 0, "p521_smaug-t5", OQS_KEM_alg_smaug_t5, KEY_TYPE_ECP_HYB_KEM , 256, 0 },
