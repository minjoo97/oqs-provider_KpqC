...
#define NID_TABLE_LEN 140
#else
#define NID_TABLE_LEN 86
#endif
...
static oqs_nid_name_t nid_names[NID_TABLE_LEN] = {
  ...
  { 0, "ntru_plus_kem576", OQS_KEM_alg_ntru_plus_kem576, KEY_TYPE_KEM, 128, 0 },
  { 0, "p256_ntru_plus_kem576", OQS_KEM_alg_ntru_plus_kem576, KEY_TYPE_ECP_HYB_KEM , 128, 0 },
  { 0, "x25519_ntru_plus_kem576", OQS_KEM_alg_ntru_plus_kem576,  KEY_TYPE_ECX_HYB_KEM , 128, 0 },
  { 0, "ntru_plus_kem768", OQS_KEM_alg_ntru_plus_kem768, KEY_TYPE_KEM, 192, 0 },
  { 0, "p384_ntru_plus_kem768", OQS_KEM_alg_ntru_plus_kem768, KEY_TYPE_ECP_HYB_KEM , 192, 0 },
  { 0, "x448_ntru_plus_kem768", OQS_KEM_alg_ntru_plus_kem768,  KEY_TYPE_ECX_HYB_KEM , 192, 0 },
  { 0, "ntru_plus_kem864", OQS_KEM_alg_ntru_plus_kem864, KEY_TYPE_KEM, 192, 0 },
  { 0, "p384_ntru_plus_kem864", OQS_KEM_alg_ntru_plus_kem864, KEY_TYPE_ECP_HYB_KEM , 192, 0 },
  { 0, "x448_ntru_plus_kem864", OQS_KEM_alg_ntru_plus_kem864,  KEY_TYPE_ECX_HYB_KEM , 192, 0 },
  { 0, "ntru_plus_kem1152", OQS_KEM_alg_ntru_plus_kem1152, KEY_TYPE_KEM, 256, 0 },
  { 0, "p521_ntru_plus_kem1152", OQS_KEM_alg_ntru_plus_kem1152, KEY_TYPE_ECP_HYB_KEM , 256, 0 },
  { 0, "smaug_t1", OQS_KEM_alg_smaug_t1, KEY_TYPE_KEM, 128, 0 },
  { 0, "p256_smaug_t1", OQS_KEM_alg_smaug_t1, KEY_TYPE_ECP_HYB_KEM , 128, 0 },
  { 0, "x25519_smaug_t1", OQS_KEM_alg_smaug_t1,  KEY_TYPE_ECX_HYB_KEM , 128, 0 },
  { 0, "smaug_t3", OQS_KEM_alg_smaug_t3, KEY_TYPE_KEM, 192, 0 },
  { 0, "p384_smaug_t3", OQS_KEM_alg_smaug_t3, KEY_TYPE_ECP_HYB_KEM , 192, 0 },
  { 0, "x448_smaug_t3", OQS_KEM_alg_smaug_t3,  KEY_TYPE_ECX_HYB_KEM , 192, 0 },
  { 0, "smaug_t5", OQS_KEM_alg_smaug_t5, KEY_TYPE_KEM, 256, 0 },
  { 0, "p521_smaug_t5", OQS_KEM_alg_smaug_t5, KEY_TYPE_ECP_HYB_KEM , 256, 0 },
       ...
       { 0, "p256_haetae2", OQS_SIG_alg_haetae_2, KEY_TYPE_HYB_SIG, 128 },
       { 0, "haetae3", OQS_SIG_alg_haetae_3, KEY_TYPE_SIG, 192 },
       { 0, "p384_haetae3", OQS_SIG_alg_haetae_3, KEY_TYPE_HYB_SIG, 192 },
       { 0, "haetae5", OQS_SIG_alg_haetae_5, KEY_TYPE_SIG, 256 },
       { 0, "p521_haetae5", OQS_SIG_alg_haetae_5, KEY_TYPE_HYB_SIG, 256 },
       { 0, "aimer128s", OQS_SIG_alg_aimer_128s, KEY_TYPE_SIG, 128 },
       { 0, "p256_aimer128s", OQS_SIG_alg_aimer_128s, KEY_TYPE_HYB_SIG, 128 },
       { 0, "aimer128f", OQS_SIG_alg_aimer_128f, KEY_TYPE_SIG, 128 },
       { 0, "p256_aimer128f", OQS_SIG_alg_aimer_128f, KEY_TYPE_HYB_SIG, 128 },
       { 0, "aimer192s", OQS_SIG_alg_aimer_192s, KEY_TYPE_SIG, 192 },
       { 0, "p384_aimer192s", OQS_SIG_alg_aimer_192s, KEY_TYPE_HYB_SIG, 192 },
       { 0, "aimer192f", OQS_SIG_alg_aimer_192f, KEY_TYPE_SIG, 192 },
       { 0, "p384_aimer192f", OQS_SIG_alg_aimer_192f, KEY_TYPE_HYB_SIG, 192 },
       { 0, "aimer256s", OQS_SIG_alg_aimer_256s, KEY_TYPE_SIG, 256 },
       { 0, "p521_aimer256s", OQS_SIG_alg_aimer_256s, KEY_TYPE_HYB_SIG, 256 },
       { 0, "aimer256f", OQS_SIG_alg_aimer_256f, KEY_TYPE_SIG, 256 },
       { 0, "p521_aimer256f", OQS_SIG_alg_aimer_256f, KEY_TYPE_HYB_SIG, 256 },
