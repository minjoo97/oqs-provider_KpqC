...
static OQS_GROUP_CONSTANTS oqs_group_list[] = {
   ...
   { 65082, 128, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },

   { 65083, 128, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
   { 65084, 128, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
   { 65085, 192, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },

   { 65086, 192, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
   { 65087, 192, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
   { 65088, 192, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },

   { 65089, 192, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
   { 65090, 192, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
   { 65091, 256, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },

   { 65092, 256, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
   { 65093, 128, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },

   { 65094, 128, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
   { 65095, 128, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
   { 65096, 192, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },

   { 65097, 192, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
   { 65098, 192, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
   { 65099, 256, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },

   { 65100, 256, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1 },
...
static OQS_SIGALG_CONSTANTS oqs_sigalg_list[] = {
    ...
    { 65101, 128, TLS1_3_VERSION, 0 },
    { 65103, 128, TLS1_3_VERSION, 0 },
    { 65104, 192, TLS1_3_VERSION, 0 },
    { 65106, 192, TLS1_3_VERSION, 0 },
    { 65107, 256, TLS1_3_VERSION, 0 },
    { 65109, 256, TLS1_3_VERSION, 0 },
    { 65073, 128, TLS1_3_VERSION, 0 },
    { 65075, 128, TLS1_3_VERSION, 0 },
    { 65110, 128, TLS1_3_VERSION, 0 },
    { 65111, 128, TLS1_3_VERSION, 0 },
    { 65076, 192, TLS1_3_VERSION, 0 },
    { 65078, 192, TLS1_3_VERSION, 0 },
    { 65112, 192, TLS1_3_VERSION, 0 },
    { 65113, 192, TLS1_3_VERSION, 0 },
    { 65079, 256, TLS1_3_VERSION, 0 },
    { 65081, 256, TLS1_3_VERSION, 0 },
    { 65114, 256, TLS1_3_VERSION, 0 },
    { 65115, 256, TLS1_3_VERSION, 0 },
...
int oqs_patch_codepoints() {
   ...
   if (getenv("OQS_CODEPOINT_NTRU_PLUS_KEM576")) oqs_group_list[35].group_id = atoi(getenv("OQS_CODEPOINT_NTRU_PLUS_KEM576"));
   if (getenv("OQS_CODEPOINT_P256_NTRU_PLUS_KEM576")) oqs_group_list[36].group_id = atoi(getenv("OQS_CODEPOINT_P256_NTRU_PLUS_KEM576"));
   if (getenv("OQS_CODEPOINT_X25519_NTRU_PLUS_KEM576")) oqs_group_list[37].group_id = atoi(getenv("OQS_CODEPOINT_X25519_NTRU_PLUS_KEM576"));
   if (getenv("OQS_CODEPOINT_NTRU_PLUS_KEM768")) oqs_group_list[38].group_id = atoi(getenv("OQS_CODEPOINT_NTRU_PLUS_KEM768"));
   if (getenv("OQS_CODEPOINT_P384_NTRU_PLUS_KEM768")) oqs_group_list[39].group_id = atoi(getenv("OQS_CODEPOINT_P384_NTRU_PLUS_KEM768"));
   if (getenv("OQS_CODEPOINT_X448_NTRU_PLUS_KEM768")) oqs_group_list[40].group_id = atoi(getenv("OQS_CODEPOINT_X448_NTRU_PLUS_KEM768"));
   if (getenv("OQS_CODEPOINT_NTRU_PLUS_KEM864")) oqs_group_list[41].group_id = atoi(getenv("OQS_CODEPOINT_NTRU_PLUS_KEM864"));
   if (getenv("OQS_CODEPOINT_P384_NTRU_PLUS_KEM864")) oqs_group_list[42].group_id = atoi(getenv("OQS_CODEPOINT_P384_NTRU_PLUS_KEM864"));
   ...
   if (getenv("OQS_CODEPOINT_HAETAE2")) oqs_sigalg_list[68].code_point = atoi(getenv("OQS_CODEPOINT_HAETAE2"));
   if (getenv("OQS_CODEPOINT_P256_HAETAE2")) oqs_sigalg_list[69].code_point = atoi(getenv("OQS_CODEPOINT_P256_HAETAE2"));
   if (getenv("OQS_CODEPOINT_HAETAE3")) oqs_sigalg_list[70].code_point = atoi(getenv("OQS_CODEPOINT_HAETAE3"));
   if (getenv("OQS_CODEPOINT_P384_HAETAE3")) oqs_sigalg_list[71].code_point = atoi(getenv("OQS_CODEPOINT_P384_HAETAE3"));
   if (getenv("OQS_CODEPOINT_HAETAE5")) oqs_sigalg_list[72].code_point = atoi(getenv("OQS_CODEPOINT_HAETAE5"));
   if (getenv("OQS_CODEPOINT_P521_HAETAE5")) oqs_sigalg_list[73].code_point = atoi(getenv("OQS_CODEPOINT_P521_HAETAE5"));
   if (getenv("OQS_CODEPOINT_AIMER128S")) oqs_sigalg_list[74].code_point = atoi(getenv("OQS_CODEPOINT_AIMER128S"));
   if (getenv("OQS_CODEPOINT_P256_AIMER128S")) oqs_sigalg_list[75].code_point = atoi(getenv("OQS_CODEPOINT_P256_AIMER128S"));
   if (getenv("OQS_CODEPOINT_AIMER128F")) oqs_sigalg_list[76].code_point = atoi(getenv("OQS_CODEPOINT_AIMER128F"));
   if (getenv("OQS_CODEPOINT_P256_AIMER128F")) oqs_sigalg_list[77].code_point = atoi(getenv("OQS_CODEPOINT_P256_AIMER128F"));
   if (getenv("OQS_CODEPOINT_AIMER192S")) oqs_sigalg_list[78].code_point = atoi(getenv("OQS_CODEPOINT_AIMER192S"));
   if (getenv("OQS_CODEPOINT_P384_AIMER192S")) oqs_sigalg_list[79].code_point = atoi(getenv("OQS_CODEPOINT_P384_AIMER192S"));
   if (getenv("OQS_CODEPOINT_AIMER192F")) oqs_sigalg_list[80].code_point = atoi(getenv("OQS_CODEPOINT_AIMER192F"));
   if (getenv("OQS_CODEPOINT_P384_AIMER192F")) oqs_sigalg_list[81].code_point = atoi(getenv("OQS_CODEPOINT_P384_AIMER192F"));
   if (getenv("OQS_CODEPOINT_AIMER256S")) oqs_sigalg_list[82].code_point = atoi(getenv("OQS_CODEPOINT_AIMER256S"));
   if (getenv("OQS_CODEPOINT_P521_AIMER256S")) oqs_sigalg_list[83].code_point = atoi(getenv("OQS_CODEPOINT_P521_AIMER256S"));
   if (getenv("OQS_CODEPOINT_AIMER256F")) oqs_sigalg_list[84].code_point = atoi(getenv("OQS_CODEPOINT_AIMER256F"));
   if (getenv("OQS_CODEPOINT_P521_AIMER256F")) oqs_sigalg_list[85].code_point = atoi(getenv("OQS_CODEPOINT_P521_AIMER256F"));
