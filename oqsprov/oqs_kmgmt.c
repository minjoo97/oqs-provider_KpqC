...
MAKE_KEM_KEYMGMT_FUNCTIONS(ntru_plus_kem576, OQS_KEM_alg_ntrupkem_576, 128)

MAKE_KEM_ECP_KEYMGMT_FUNCTIONS(p256_ntru_plus_kem576, OQS_KEM_alg_ntrupkem_576, 128)

MAKE_KEM_ECX_KEYMGMT_FUNCTIONS(x25519_ntru_plus_kem576, OQS_KEM_alg_ntrupkem_576, 128, 0)
MAKE_KEM_KEYMGMT_FUNCTIONS(ntru_plus_kem768, OQS_KEM_alg_ntrupkem_768, 192)

MAKE_KEM_ECP_KEYMGMT_FUNCTIONS(p384_ntru_plus_kem768, OQS_KEM_alg_ntrupkem_768, 192)

MAKE_KEM_ECX_KEYMGMT_FUNCTIONS(x448_ntru_plus_kem768, OQS_KEM_alg_ntrupkem_768, 192, 0)
MAKE_KEM_KEYMGMT_FUNCTIONS(ntru_plus_kem864, OQS_KEM_alg_ntrupkem_864, 192)

MAKE_KEM_ECP_KEYMGMT_FUNCTIONS(p384_ntru_plus_kem864, OQS_KEM_alg_ntrupkem_864, 192)

MAKE_KEM_ECX_KEYMGMT_FUNCTIONS(x448_ntru_plus_kem864, OQS_KEM_alg_ntrupkem_864, 192, 0)
MAKE_KEM_KEYMGMT_FUNCTIONS(ntru_plus_kem1152, OQS_KEM_alg_ntrupkem_1152, 256)

MAKE_KEM_ECP_KEYMGMT_FUNCTIONS(p521_ntru_plus_kem1152, OQS_KEM_alg_ntrupkem_1152, 256)
MAKE_KEM_KEYMGMT_FUNCTIONS(smaug-t1, OQS_KEM_alg_smaug_t1, 128)

MAKE_KEM_ECP_KEYMGMT_FUNCTIONS(p256_smaug-t1, OQS_KEM_alg_smaug_t1, 128)

MAKE_KEM_ECX_KEYMGMT_FUNCTIONS(x25519_smaug-t1, OQS_KEM_alg_smaug_t1, 128, 0)
MAKE_KEM_KEYMGMT_FUNCTIONS(smaug-t3, OQS_KEM_alg_smaug_t3, 192)

MAKE_KEM_ECP_KEYMGMT_FUNCTIONS(p384_smaug-t3, OQS_KEM_alg_smaug_t3, 192)

MAKE_KEM_ECX_KEYMGMT_FUNCTIONS(x448_smaug-t3, OQS_KEM_alg_smaug_t3, 192, 0)
MAKE_KEM_KEYMGMT_FUNCTIONS(smaug-t5, OQS_KEM_alg_smaug_t5, 256)

MAKE_KEM_ECP_KEYMGMT_FUNCTIONS(p521_smaug-t5, OQS_KEM_alg_smaug_t5, 256)
